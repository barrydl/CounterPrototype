...
# 44 "./mcc_generated_files/system/../timer/timer_interface.h" 2
...
void Tmr1CallBack(void) {
    ...
    PORTCbits.RC3 = toggle ^ ten.c;
    PORTCbits.RC6 = toggle ^ ten.d;
    PORTCbits.RC7 = toggle ^ ten.e;
    PORTBbits.RB7 = toggle ^ ten.f;
    PORTBbits.RB6 = toggle ^ ten.g;

    PORTBbits.RB5 = toggle ^ one.a;
    PORTBbits.RB4 = toggle ^ one.b;
    PORTCbits.RC2 = toggle ^ one.c;
    PORTCbits.RC1 = toggle ^ one.d;
